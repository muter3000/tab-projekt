...
type Kurs struct {
	...
	Id              int32      `pg:"id,pk" json:"id"`
	DataRozpoczecia *time.Time `pg:"data_rozpoczecia, notnull" json:"data_rozpoczecia"`
	DataZakonczenia *time.Time `pg:"data_zakonczenia, notnull" json:"data_zakonczenia"`
